		...
		<div class="c-right c-right1">
			<div class="member-main">
					...
					<div class="controls">
						...
						<div class="controls">
							...
							<c:forEach items="${list}" var="keyword">
   								<img src="/${keyword}" id="img1" style="width: 200px;" >
							</c:forEach>
				...
				<div class="controls qt-zj" style="padding-bottom: 20px;center;">
					<a href="/final/changetruefianl?userid=${user.userid}&limit=三审通过"
						class="btn02 l mr20" style="width: 190px;" >审核通过</a> <a
						href="/final/changetruefianl?userid=${user.userid}&limit=三审不通过"
