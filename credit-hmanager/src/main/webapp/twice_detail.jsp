			...
			<div class="member-main">
				...
				<div class="member-column">
					...
					<div class="member-con">
						...
						<div class="controls">
							<p>提交时间：</p>
							<div class="basic-name"><fmt:formatDate value="${apply.updatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
						</div>
					</div>
				</div>
				<div class="member-column">
					...
					<div class="member-con">
						...
						<div class="controls">
							<p>提交时间：</p>
							<div class="basic-name"><fmt:formatDate value="${user.updatetime}" pattern="yyyy-MM-dd HH:mm:ss"/></div>
						</div>
