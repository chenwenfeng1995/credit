...
<body class="rel">
	...
	<div class="w1200 auto contant rel">
		...
		<div class="c-left">
			...
			<div class="l-menu">
				<ul class="nav_li">
					<li class="selected"><a href="javascript:">借款人信息</a></li>
				</ul>
			</div>
		</div>
		<!-- 左侧end -->
			...
			<form action="user/findall" method="post">
				<div class="search-member">
					<dl>
						<dd>
							<label for="">
								<p class="mt5">借款人：</p> <input type="text"
					...
					<tbody>
						<c:forEach items="${userList}" var="user">
							<tr>
								...
								<td>${user.income}</td>
								<td class="c-z">
								<a href="/rc/finaldetails?userid=${user.userid}">个人详情</a> 
								<a href="/rc/findRepayById?userid=${user.userid}">借款信息</a>
							</td>
							</tr>
					</c:forEach>
