...
<body>
	...
	<div class="zscf_banner_wper">
		<div class="zscf_banner px1000">
			<div class="zscf_box">
				<p>
					累计成交：<strong>12亿2332万元</strong>
				</p>
				<p>
					运营时间：<strong>123天</strong>
				</p>
				<p>
					<strong>24</strong>小时成功转让率<strong>12.12%</strong>
				</p>
				<a href="#" class="btn btn1">立即登录</a><br> <a href="#"
					class="btn btn2">立即注册</a>
			</div>
		</div>
	</div>
	<!-- end banner -->
	<div class="zscf_con_wper pb30">
		<div class="zscf_con px1000">
			<div class="zscf_block1 mt30 ">
				<h2 class="zscf_block1_tit clearfix">
					<span class="fl"><strong>发标预告</strong>换卡后放假啊客户看
						将黑金卡号看见啊后防盗卡…… </span><a href="#" class="fr">查看更多>></a>
				</h2>
				<div class="clearfix clear">
					<ul class="zscf_block1_text clearfix fl">
						<li><span class="block1_libg01">已加入中兴财富</span> <br> <em><strong>123123</strong>人</em>
						</li>
						<li><span class="block1_libg02">已加入中兴财富</span> <br> <em><strong>123123</strong>人</em>
						</li>
						<li><span class="block1_libg03">已加入中兴财富</span> <br> <em><strong>123123</strong>人</em>
						</li>
					</ul>
					<!-- end l -->
					<div class="block1_r fl">
						<h2 class="block1_r_tit clearfix">
							<span>网站公告</span><a href="noticelist.html">+</a>
						</h2>
						<ul>
				...
				<div class="zscf_block2_l fl">
					<div class="block2_biao clearfix">
						...
						<ul class="clearfix clear block2_biao_ul">
							...
							<li>产品期限：<span>7天</span>
							</li>
							<li>借款金额：<span>2000000元</span>
							</li>
							<li><a href="11112/detail.html" class="invest_btn">立即投资</a>
							</li>
						</ul>
					</div>
			...
			<div class="zscf_block3 mt30 ">
				<h2 class="block3_tit clearfix">
					<span class="block3_curspan">项目列表</span><em><img
						src="images/shu.png" alt=""></em><span>债权转让</span><a href="#">更多></a>
				</h2>
				<div class="block3_pro_box clear">
					<div class="block3_prolist">

						<div class="block3_proone clearfix clear">
							<span class="fl proone_left"><img src="images/xin.png"
								alt=""></span>
							<!--  -->
					...
					<!-- end 项目列表 -->
					<div class="block3_prolist" style="display: none;">2</div>
				</div>
			</div>
			<!-- end block3 -->
			...
			<div class="zscf_block5 mt30 clearfix">
				<div class="zscf_block5_l fl mr20">
					<h2 class="block3_tit clearfix block5_l_tit">
						<span class="block3_curspan news_span">行业动态</span><em><img
							src="images/shu.png" alt=""></em><span class="news_span">媒体报道</span><a
							href="#">更多></a>
					</h2>
				...
				<div class="zscf_block5_r fl">
					<h2 class="block5_r_tit clearfix">
						<span class="fl ">投资排行榜</span><em class="fr block5_r_tit_em"><a
							href="javascript:;" class="brt_acur">月排行</a><a
							href="javascript:;">周排行</a><a href="javascript:;">总排行</a></em>
					</h2>
					<div class="rank_box">
						<div class="rank_list">
							<ul class="rank_list_ul">
								<li><em class="rank_bg01">1</em> <a href="#">llsdfasd</a> <span>￥132423</span>
									<span>99</span> <span>1233%</span></li>
								<li><em class="rank_bg02">1</em> <a href="#">llsdfasd</a> <span>￥132423</span>
									<span>99</span> <span>1233%</span></li>
								<li><em class="rank_bg03">1</em> <a href="#">llsdfasd</a> <span>￥132423</span>
									<span>99</span> <span>1233%</span></li>

								<li><em class="rank_bg04">1</em> <a href="#">llsdfasd</a> <span>￥132423</span>
									<span>99</span> <span>1233%</span></li>
						...
						<!-- end -->
						<div class="rank_list" style="display: none;">2</div>
						<!-- end -->
						<div class="rank_list" style="display: none;">3</div>
						<!-- end -->
					</div>
				</div>
			</div>
			...
			<div class="zscf_partner mt30">
				...
				<div class="partner_con">
					<div id="demo">
						<div id="indemo">
							<div id="demo1">
								<a href="#"><img src="images/ifri01.png" border="0" /></a> <a
									href="#"><img src="images/ifri01.png" border="0" /></a> <a
									href="#"><img src="images/ifri01.png" border="0" /></a> <a
									href="#"><img src="images/ifri01.png" border="0" /></a> <a
									href="#"><img src="images/ifri01.png" border="0" /></a> <a
									href="#"><img src="images/ifri01.png" border="0" /></a>
							</div>
							<div id="demo2"></div>
						</div>
					</div>
